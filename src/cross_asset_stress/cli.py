"""Cross-Asset Stress Monitor command-line interface."""
...
from cross_asset_stress.data.point_in_time import build_point_in_time_feature_matrix
from cross_asset_stress.data.synthetic import (
    CLEAN_FEATURES,
...
from cross_asset_stress.experiments.bloomberg_quicklook import run_bloomberg_quicklook
from cross_asset_stress.experiments.intraday_impulse_pca import run_intraday_impulse_pca
...
app = typer.Typer(help="Cross-Asset Stress Monitor research CLI.", no_args_is_help=True)
